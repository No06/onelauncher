...
const kGameConfigName = "$appName.json";
const kConfigDirectoryName = appName;
final kConfigPath =
    Future(() async => join((await getApplicationDocumentsDirectory()).path, kConfigDirectoryName));
